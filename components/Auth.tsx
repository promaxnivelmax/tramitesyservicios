...
export const Auth: React.FC<Props> = ({ onLoginSuccess, onCancel }) => {
  ...
  return (
    <div className="min-h-screen bg-tyLightGrey flex items-center justify-center px-4 animate-slide-up">
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        
        <div className="bg-tyGrey p-6 text-center relative">
        ...
        <div className="p-8">
          <form onSubmit={isRegistering ? handleRegister : handleLogin} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-tyYellow focus:border-transparent transition"
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-tyYellow text-tyGrey font-bold py-3 rounded-lg hover:bg-yellow-500 transition shadow-lg transform hover:-translate-y-1 flex justify-center gap-2 items-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center border-t pt-4">
            <button 
              ...
              className="text-tyGrey text-sm hover:underline font-medium"
            >
