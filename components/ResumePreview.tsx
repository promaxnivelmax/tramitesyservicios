...
export const ResumePreview: React.FC<Props> = ({ data, onEdit, onExit }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 py-10 flex flex-col items-center gap-6 animate-slide-up no-print">
      ...
      <div className="pdf-container overflow-hidden p-4">
        <div ref={containerRef} className="resume-sheet">
...
const DesignMasculino = ({ data }: { data: ResumeData }) => (
    <div className="h-full w-full flex flex-col font-sans text-slate-900 bg-white overflow-hidden">
        <div className="h-[20%] bg-[#0f172a] p-10 flex justify-between items-center relative overflow-hidden text-white shrink-0">
            ...
            <div className="relative z-10 flex-1 pr-10 overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex p-10 gap-10 bg-white">
            <div className="w-[32%] space-y-5 text-[11px] overflow-hidden">
                <section>
                    <h3 className="font-black uppercase tracking-widest mb-3 text-tyYellow border-b border-slate-100 pb-1">Identificación</h3>
                ...
                <section>
                    ...
                    <div className="space-y-3">
                        {data.references.slice(0, 3).map(ref => (
            ...
            <div className="w-[68%] space-y-6">
                    ...
                    <div className="space-y-4">
                        {data.experience.slice(0, 4).map(exp => (
                            <div key={exp.id} className="relative pl-8 border-l-2 border-slate-100 pb-1">
                                ...
                                <p className="font-bold text-tyYellow text-[10px] uppercase mb-0.5">{exp.company}</p>
                                <p className="text-[10px] leading-snug text-slate-500 italic line-clamp-1">Responsabilidad y cumplimiento de metas.</p>
                            </div>
                        ))}
                    </div>
                </section>
                <section>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {data.education.slice(0, 4).map(edu => (
                            <div key={edu.id} className="flex justify-between items-center bg-[#f8fafc] p-3 rounded-xl border border-slate-100 overflow-hidden">
        ...
        <div className="p-10 pt-4 mt-auto shrink-0 bg-white">
...
const DesignFemenino = ({ data }: { data: ResumeData }) => (
    <div className="h-full w-full flex flex-col font-serif bg-[#fffaf5] text-[#5c4a40] overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex overflow-hidden bg-[#fffaf5]">
            <div className="w-[36%] bg-white border-r border-[#f3e3d8] p-8 space-y-6 text-[11px] overflow-hidden shrink-0">
                 {data.personal.photo && (
                 ...
                 <section className="font-sans">
                    <h3 className="text-[10px] font-black uppercase tracking-[0.3em] mb-3 text-[#b08d70] border-b border-[#f3e3d8] pb-1">Contacto</h3>
                 ...
                 <section className="font-sans">
                    ...
                    <div className="space-y-3">
                        {data.references.slice(0, 3).map(ref => (
                            <div key={ref.id} className="bg-[#fffaf5] p-3 rounded-2xl border border-[#f3e3d8] overflow-hidden">
            ...
            <div className="w-[64%] p-10 space-y-8 font-sans overflow-hidden">
                <section>
                    ...
                    <div className="space-y-6">
                        {data.experience.slice(0, 4).map(exp => (
                            <div key={exp.id}>
                                ...
                                <p className="text-[10px] font-black uppercase text-[#b08d70] mb-1.5">{exp.company}</p>
                                <p className="text-[11px] italic leading-relaxed text-[#8a7060] border-l-2 border-[#f3e3d8] pl-4 line-clamp-2">Cumplimiento eficiente de labores.</p>
                            </div>
                        ))}
                    </div>
                </section>
                <section>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {data.education.slice(0, 4).map(edu => (
                            <div key={edu.id} className="flex gap-4 items-center bg-white p-3 rounded-xl shadow-sm border border-[#f3e3d8] overflow-hidden">
...
const DesignATS = ({ data }: { data: ResumeData }) => (
    <div className="h-full w-full p-16 font-sans text-slate-800 bg-white flex flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 space-y-10 overflow-hidden">
            <section>
                ...
                {data.experience.slice(0, 5).map(exp => (
                    <div key={exp.id} className="mb-4">
                        ...
                        <p className="text-slate-500 text-[11px] leading-relaxed italic line-clamp-1">Eficiencia y cumplimiento laboral.</p>
                    </div>
                ))}
            </section>
            <section>
            ...
            <section>
                ...
                <div className="grid grid-cols-2 gap-x-12 gap-y-4 overflow-hidden">
                    {data.references.slice(0, 4).map(ref => (
        ...
        <div className="pt-8 mt-auto shrink-0 bg-white">
...
const DesignNeutro = ({ data, palette }: { data: ResumeData, palette: string }) => (
    <div className="h-full w-full flex flex-col font-sans text-slate-800 bg-white overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex overflow-hidden bg-white">
            <div className="w-[32%] bg-slate-50 p-8 space-y-10 text-[11px] font-bold text-slate-500 overflow-hidden border-r border-slate-100 shrink-0">
                <section>
                    <h3 className="uppercase tracking-widest mb-4 pb-1 border-b-2" style={{ borderBottomColor: palette, color: palette }}>Contacto</h3>
                    <div className="space-y-4">
                ...
                <section>
                    ...
                    <div className="space-y-6">
                        {data.references.slice(0, 3).map(ref => (
                            <div key={ref.id} className="overflow-hidden">
            ...
            <div className="w-[68%] p-10 space-y-8 overflow-hidden bg-white">
                <section>
                    ...
                    <div className="space-y-8">
                        {data.experience.slice(0, 5).map(exp => (
                            <div key={exp.id}>
                                ...
                                <p className="text-[11px] font-bold uppercase mb-2" style={{ color: palette }}>{exp.company}</p>
                                <p className="text-[12px] leading-relaxed text-slate-500 italic line-clamp-1">Eficiencia y compromiso profesional.</p>
                            </div>
                        ))}
                    </div>
                </section>
                <section>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {data.education.slice(0, 4).map(edu => (
                            <div key={edu.id} className="flex justify-between items-center p-4 rounded-xl border-l-4 bg-slate-50 overflow-hidden" style={{ borderLeftColor: palette }}>
                                <div className="flex-1 pr-4">
...
const Signature = ({ data, border }: { data: ResumeData, border: string }) => (
    <div className="pt-3 border-t-2 min-w-[320px] max-w-full inline-block shrink-0 overflow-visible" style={{ borderColor: border }}>
        <p className="font-black uppercase text-[16px] leading-tight mb-1 whitespace-nowrap overflow-visible">{data.personal.firstName} {data.personal.lastName}</p>
        <p className="text-slate-400 font-bold text-[10px] tracking-wider uppercase whitespace-nowrap overflow-visible">C.C. No. {data.personal.docNumber} de {data.personal.expeditionPlace}</p>
    </div>
);
